...
export const MASTER_STOCKS_LIST: MasterStock[] = [
  // Gold & Silver ETFs & Mutual Funds
  { symbol: 'SETFGOLD', name: 'SBI ETF Gold (SBI Gold ETF / SBI Gold Fund)', sector: 'Jewellery' },
  { symbol: 'GOLDBEES', name: 'Nippon India ETF Gold BeES (Gold BeES)', sector: 'Jewellery' },
  { symbol: 'HDFCGOLD', name: 'HDFC Gold ETF', sector: 'Jewellery' },
  { symbol: 'AXISGOLD', name: 'Axis Gold ETF', sector: 'Jewellery' },
  { symbol: 'ICICIGOLD', name: 'ICICI Prudential Gold ETF', sector: 'Jewellery' },
  { symbol: 'KOTAKGOLD', name: 'Kotak Gold ETF', sector: 'Jewellery' },
  { symbol: 'TATAGOLD', name: 'Tata Gold ETF', sector: 'Jewellery' },
  { symbol: 'UTIGOLD', name: 'UTI Gold ETF', sector: 'Jewellery' },
  { symbol: 'SILVERBEES', name: 'Nippon India ETF Silver BeES (Silver BeES)', sector: 'Jewellery' },
  { symbol: 'SETFSILVER', name: 'SBI Silver ETF', sector: 'Jewellery' },
  { symbol: 'HDFCSILVER', name: 'HDFC Silver ETF', sector: 'Jewellery' },
  { symbol: 'ICICISILVE', name: 'ICICI Prudential Silver ETF', sector: 'Jewellery' },
  { symbol: 'KOTAKSILVE', name: 'Kotak Silver ETF', sector: 'Jewellery' },
  { symbol: 'TATASILV', name: 'Tata Silver ETF', sector: 'Jewellery' },

  // Index & Sectoral ETFs
  { symbol: 'NIFTYBEES', name: 'Nippon India ETF Nifty 50 BeES (Nifty BeES)', sector: 'Trading' },
  { symbol: 'SETFNIF50', name: 'SBI ETF Nifty 50 (SBI Nifty ETF)', sector: 'Trading' },
  { symbol: 'HDFCNIFTY', name: 'HDFC Nifty 50 ETF', sector: 'Trading' },
  { symbol: 'ICICINIFTY', name: 'ICICI Prudential Nifty 50 ETF', sector: 'Trading' },
  { symbol: 'UTINIFTETF', name: 'UTI Nifty 50 ETF', sector: 'Trading' },
  { symbol: 'KOTAKNIFTY', name: 'Kotak Nifty 50 ETF', sector: 'Trading' },
  { symbol: 'JUNIORBEES', name: 'Nippon India ETF Nifty Next 50 (Junior BeES)', sector: 'Trading' },
  { symbol: 'MID150BEES', name: 'Nippon India ETF Nifty Midcap 150', sector: 'Trading' },
  { symbol: 'HDFCMID150', name: 'HDFC Nifty Midcap 150 ETF', sector: 'Trading' },
  { symbol: 'BANKBEES', name: 'Nippon India ETF Bank BeES (Nifty Bank BeES)', sector: 'Bank' },
  { symbol: 'SETFNIFBK', name: 'SBI ETF Nifty Bank (SBI Bank ETF)', sector: 'Bank' },
  { symbol: 'HDFCBANKETF', name: 'HDFC Nifty Bank ETF', sector: 'Bank' },
  { symbol: 'KOTAKBKETF', name: 'Kotak Nifty Bank ETF', sector: 'Bank' },
  { symbol: 'ITBEES', name: 'Nippon India ETF IT BeES (Nifty IT BeES)', sector: 'IT' },
  { symbol: 'SETFNIFIT', name: 'SBI ETF Nifty IT (SBI IT ETF)', sector: 'IT' },
  { symbol: 'AUTOBEES', name: 'Nippon India ETF Auto BeES', sector: 'Automobile' },
  { symbol: 'PHARMABEES', name: 'Nippon India ETF Pharma BeES', sector: 'Pharma' },
  { symbol: 'FMCGBEES', name: 'Nippon India ETF FMCG BeES', sector: 'FMCG' },
  { symbol: 'INFRABEES', name: 'Nippon India ETF Infra BeES', sector: 'Trading' },
  { symbol: 'CPSEETF', name: 'CPSE ETF (Central Public Sector Enterprises)', sector: 'Trading' },
  { symbol: 'BHARAT22', name: 'Bharat 22 ETF', sector: 'Trading' },
  { symbol: 'HDFCMOMENT', name: 'HDFC Nifty200 Momentum 30 ETF', sector: 'Trading' },
  { symbol: 'LIQUIDBEES', name: 'Nippon India ETF Liquid BeES', sector: 'Trading' },
  { symbol: 'LIQUIDETF', name: 'DSP Liquid ETF', sector: 'Trading' },

  // International & US ETFs
  { symbol: 'MON100', name: 'Motilal Oswal Nasdaq 100 ETF (US Tech)', sector: 'IT' },
  { symbol: 'MAFANG', name: 'Mirae Asset NYSE FANG+ ETF', sector: 'IT' },
  { symbol: 'MASPTOP50', name: 'Mirae Asset S&P 500 Top 50 ETF', sector: 'Trading' },
  { symbol: 'HDFCSML250', name: 'HDFC Nifty Smallcap 250 ETF', sector: 'Trading' },
  { symbol: 'SPY', name: 'SPDR S&P 500 ETF Trust', sector: 'Trading' },
  { symbol: 'QQQ', name: 'Invesco QQQ Trust (Nasdaq 100)', sector: 'IT' },
  { symbol: 'VOO', name: 'Vanguard S&P 500 ETF', sector: 'Trading' },
  { symbol: 'VTI', name: 'Vanguard Total Stock Market ETF', sector: 'Trading' },
  { symbol: 'SMH', name: 'VanEck Semiconductor ETF', sector: 'IT' },
  { symbol: 'DIA', name: 'SPDR Dow Jones Industrial Average ETF', sector: 'Trading' },

  // Popular Mutual Funds (Direct / Regular Schemes)
  { symbol: '0P0000XW8W.BO', name: 'Parag Parikh Flexi Cap Fund - Direct Plan - Growth (PPFAS)', sector: 'Trading' },
  { symbol: '0P0000YWL2.BO', name: 'Quant Small Cap Fund - Direct Plan - Growth', sector: 'Trading' },
  { symbol: '0P0000XU04.BO', name: 'Mirae Asset Large & Midcap Fund - Direct Plan - Growth', sector: 'Trading' },
  { symbol: '0P0000Y2BH.BO', name: 'Nippon India Small Cap Fund - Direct Plan - Growth', sector: 'Trading' },
  { symbol: '0P00005VMR.BO', name: 'HDFC Mid-Cap Opportunities Fund - Direct Plan - Growth', sector: 'Trading' },
  { symbol: '0P00009J8W.BO', name: 'SBI Small Cap Fund - Direct Plan - Growth', sector: 'Trading' },
  { symbol: '0P0000XU6L.BO', name: 'ICICI Prudential Bluechip Fund - Direct Plan - Growth', sector: 'Trading' },
  ...
  {
    "symbol": "ASHIKAG",
    "name": "Ashika Global Securities Limited"
  },
  {
    "symbol": "ASHIMASYN",
    "name": "Ashima Limited"
  ...
  {
    "symbol": "ASMS",
    "name": "Avio Smart Market Stack Limited"
  },
  {
    "symbol": "ASPINWALL",
  ...
  {
    "symbol": "CRSL",
    "name": "Cressanda Railway Solutions Limited"
  },
  {
    "symbol": "CSBBANK",
  ...
  {
    "symbol": "GAUDIUMIVF",
    "name": "Gaudium IVF and Women Health Limited"
  },
  {
    "symbol": "GAYAHWS",
  ...
  {
    "symbol": "HTEL",
    "name": "Hy-Tech Engineers Limited"
  },
  {
    "symbol": "HTMEDIA",
  ...
  {
    "symbol": "JAYKAY-RE1",
    "name": "Jaykay Enterprises Limited-RE"
  },
  {
    "symbol": "JAYNECOIND",
  ...
  {
    "symbol": "KDGREEN",
    "name": "KD Green Industries Limited"
  },
  {
    "symbol": "KEC",
  ...
  {
    "symbol": "MYSORPETRO",
    "name": "Mysore Petro Chemicals Limited"
  },
  {
    "symbol": "NACLIND",
  ...
  {
    "symbol": "NEUEON",
    "name": "Neueon Corporation Limited"
  },
  {
    "symbol": "NEULANDLAB",
  ...
  {
    "symbol": "SIGMAADV",
    "name": "SIGMA ADVANCED SYSTEMS LIMITED"
  },
  {
    "symbol": "SIGNATURE",
  ...
  {
    "symbol": "SYMBIOTEC",
    "name": "Symbiotec Pharmalab Limited"
  },
  {
    "symbol": "SYMPHONY",
...
export function inferSector(name: string, sym: string): string {
  ...
  if (
    ...
    n.includes('credit') ||
    n.includes('bajajfin') ||
    n.includes('cholamandalam') ||
    n.includes('muthoot') ||
    n.includes('manappuram') ||
    n.includes('shriram') ||
    n.includes('lic hsg') ||
    n.includes('pnbhousing') ||
    n.includes('can fin') ||
    n.includes('edelweiss') ||
    n.includes('motilal') ||
    n.includes('angel one') ||
    n.includes('iifl')
  )
    return 'NBFC';
  if (
    ...
    n.includes('wipro') ||
    n.includes('hcl') ||
    n.includes('l&t technology') ||
    n.includes('lti') ||
    n.includes('mindtree') ||
    n.includes('persistent') ||
    n.includes('coforge') ||
    n.includes('mphasis') ||
    n.includes('birlasoft') ||
    n.includes('tata elxsi') ||
    n.includes('kpit') ||
    n.includes('cyient') ||
    n.includes('zensar') ||
    n.includes('apple') ||
  ...
  if (
    ...
    n.includes('hospital') ||
    n.includes('dr reddy') ||
    n.includes('sun pharma') ||
    n.includes('cipla') ||
    n.includes('lupin') ||
    n.includes('aurobindo') ||
    n.includes('divis') ||
    n.includes('torrent pharm') ||
    n.includes('alkem') ||
    n.includes('zydus') ||
    n.includes('mankind') ||
    n.includes('apollo hosp') ||
    n.includes('max health') ||
    n.includes('fortis') ||
    n.includes('biocon')
  )
    return 'Pharma';
  if (
    ...
    n.includes('auto') ||
    n.includes('maruti') ||
    n.includes('tata motors') ||
    n.includes('mahindra') ||
    n.includes('hero') ||
    n.includes('bajaj auto') ||
    n.includes('eicher') ||
    n.includes('tvs') ||
    n.includes('ashok leyland') ||
    n.includes('bharat forge') ||
    n.includes('mrf') ||
    n.includes('apollo tyre') ||
    n.includes('balkrishna') ||
    n.includes('motherson') ||
    n.includes('sona blw') ||
    n.includes('bosch') ||
    n.includes('tesla')
  )
  ...
  if (
    ...
    n.includes('iron') ||
    n.includes('jsw') ||
    n.includes('tata steel') ||
    n.includes('jindal') ||
    n.includes('sail') ||
    n.includes('hindalco') ||
    n.includes('vedanta') ||
    n.includes('nalco') ||
    n.includes('national aluminium') ||
    n.includes('ratnamani') ||
    n.includes('aplapollo')
  )
    return 'Steel/ Iron Products';
  if (
    n.includes('oil') ||
    n.includes('petrol') ||
    n.includes('petro') ||
    ...
    n.includes('hpcl') ||
    n.includes('ioc') ||
    n.includes('indian oil') ||
    n.includes('gail') ||
    n.includes('mngl') ||
    n.includes('igl') ||
    n.includes('gujarat gas') ||
    n.includes('petronet')
  )
    return 'Refineries';
  if (
    ...
    n.includes('energy') ||
    n.includes('ntpc') ||
    n.includes('tata power') ||
    n.includes('adani power') ||
    n.includes('adani green') ||
    n.includes('adani energy') ||
    n.includes('nhpc') ||
    n.includes('jsw energy') ||
    n.includes('torrent power') ||
    n.includes('suzlon') ||
    n.includes('inox wind') ||
    n.includes('cesc') ||
    n.includes('sjvn') ||
    n.includes('ireda')
  )
  ...
  if (
    ...
    n.includes('itc') ||
    n.includes('hul') ||
    n.includes('hindustan unilever') ||
    n.includes('nestle') ||
    n.includes('britannia') ||
    n.includes('dabur') ||
    n.includes('marico') ||
    n.includes('godrej consumer') ||
    n.includes('colgate') ||
    n.includes('emami') ||
    n.includes('varun beverages') ||
    n.includes('tata consumer') ||
    n.includes('bikaji') ||
    n.includes('mrs bectors') ||
    n.includes('hatsun') ||
    n.includes('zomato')
  )
    return 'FMCG';
  if (
    ...
    n.includes('kalyan') ||
    n.includes('senco') ||
    n.includes('thangamayil') ||
    n.includes('pc jeweller')
  )
    return 'Jewellery';
  if (
    n.includes('telecom') ||
    ...
    n.includes('bharti') ||
    n.includes('vodafone') ||
    n.includes('tata comm') ||
    n.includes('indus towers') ||
    n.includes('tejas')
  )
  ...
  if (
    ...
    n.includes('dlf') ||
    n.includes('macrotech') ||
    n.includes('lodha') ||
    n.includes('godrej properties') ||
    n.includes('oberoi') ||
    n.includes('prestige') ||
    n.includes('sobha') ||
    n.includes('brigade') ||
  ...
  if (
    ...
    n.includes('aarti') ||
    n.includes('deepak nitrite') ||
    n.includes('srfc') ||
    n.includes('navin fluorine') ||
    n.includes('pi ind') ||
    n.includes('tata chem') ||
    n.includes('atul') ||
    n.includes('coromandel') ||
    n.includes('chambal')
  )
...
export function searchMasterStocks(query: string, limit = 35): MasterStock[] {
  if (!query || !query.trim()) return [];
  const q = query.trim().toLowerCase();
  const qClean = q.replace(/[^a-z0-9]/g, '');
  const qWords = q.split(/\s+/).filter(Boolean);

  const exactSymMatches: MasterStock[] = [];
  const startSymMatches: MasterStock[] = [];
  const startNameMatches: MasterStock[] = [];
  const wordMatches: MasterStock[] = [];
  const otherMatches: MasterStock[] = [];

  for (const s of MASTER_STOCKS_LIST) {
    const sym = s.symbol.toLowerCase();
    const symClean = sym.replace(/[^a-z0-9]/g, '');
    const name = s.name.toLowerCase();
    const nameClean = name.replace(/[^a-z0-9]/g, '');
    const sector = s.sector || inferSector(s.name, s.symbol);
    const itemWithSector: MasterStock = { ...s, sector };

    if (sym === q || (qClean.length >= 3 && symClean === qClean)) {
      exactSymMatches.push(itemWithSector);
    } else if (sym.startsWith(q) || (qClean.length >= 3 && symClean.startsWith(qClean))) {
      startSymMatches.push(itemWithSector);
    } else if (name.startsWith(q) || (qClean.length >= 3 && nameClean.startsWith(qClean))) {
      startNameMatches.push(itemWithSector);
    } else if (
      qWords.length > 1 &&
      qWords.every((w) => name.includes(w) || sym.includes(w))
    ) {
      wordMatches.push(itemWithSector);
    } else if (
      sym.includes(q) ||
      name.includes(q) ||
      (qClean.length >= 3 && nameClean.includes(qClean))
    ) {
      otherMatches.push(itemWithSector);
    }
  }
